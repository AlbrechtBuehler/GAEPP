...
/* ====================================================================
   ...
   und raeumt ausserdem Band, Blattkopf, Druckkopf, Druckfuss und Dialoge —
   das wird hier zusaetzlich gemessen. */
console.log('\n4. Eine kaputte Datendatei legt GAEPP nicht still, dazu der Notausgang');
...
const notausgang = await seite.evaluate(() => {
  ...
  return { text: leer.textContent, kopf: leer.querySelector('h2') ? leer.querySelector('h2').textContent : null,
    ...
    band: leerId('band'), blattkopf: leerId('blattkopf'), druckkopf: leerId('druckkopf'),
...
if (notausgang) {
  ...
  gleich('der Blattkopf ist geraeumt', notausgang.blattkopf, '');
