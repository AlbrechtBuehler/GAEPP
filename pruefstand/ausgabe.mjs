...
import { serve, browser, bisRuhe, bilanzbuch } from './hilfe.mjs';
...
const papier = await seite.evaluate(() => {
  ...
  return {
    ...
    kopf1: aus('.kopf1'), kopf2: aus('.kopf2'), kopf3: aus('.kopf3'),
...
pruef('die Fensterleiste ist weg',
  papier.kopf1 === true && papier.kopf2 === true && papier.kopf3 === true && papier.leiste === 0,
  [papier.kopf1, papier.kopf2, papier.kopf3, papier.leiste].join('/'));
